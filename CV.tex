...
\begin{document}
	...
	%----------------------------------------------------------------------------------------
	\cvSection{Summary}
        \CVTextBlock{Computer Science student interested in Systems Programming
        and Administration, Infrastructure management, and Cybersecurity. I
        have contributed to many open-source projects using a variety of
        languages and tools, and am looking to increase my exposure to
        real-world, corporate use-cases. I'm a versatile programmer and a quick
...
%	\cvSection{Experience (Research \& Industry)}
	...
	\CVBlockWithTime{Mobile Applications Development Intern}{Summer 2020}{ObjectWin, Inc.}{Houston, Texas (Remote)}
        {Worked with an \textbf{international team} to develop an internal
        timesheet entry \textbf{mobile application} for tech consulting company
        ObjectWin. Learned to work with a team across time \& language
        barriers, using tools of a modern workplace. \textbf{Reduced
        operational overhead} for consultants by optimizing non-billable time.
        \\ \textbf{AngularJS \cvContactSpace Ionic \cvContactSpace SQL Server}}
	...
	\CVBlockWithTime{National AP Scholar}{2020}{Grapevine High School}{United States}
        ...
        exams.}
        \CVBlockWithTime{Director's Choice}{2021}{Grapevine High School
